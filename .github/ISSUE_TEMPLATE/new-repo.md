...
- [ ] [Set up](https://github.com/knative/test-infra/blob/master/guides/prow_knative_setup.md#setting-up-prow-for-a-new-repo-reviewers-assignment-and-auto-merge) for a new repo

- [ ] Bootstrap your CI jobs using [hack](https://github.com/knative-sandbox/hack) project (look at other sandbox repos for reference)
